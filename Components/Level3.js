...
const handleCalculateTotal = () => {
  ...
  const handleCalculateDivider = () => {
    ...
    const CalculatedDivider = (number1 + number2 + randomNumber)/4;
    ...
    const calculatedFinalResult = (number1+number2+randomNumber) / 4-sNumber1;
  ...
  const handleCalculateResult = () => {
    ...
    const calculatedResult = randomNumber / 4;
...
/>
<Text>Automatically Taken Three Times of Your  Number</Text>
      <TextInput
  style={{
    height: 40,
    borderColor: 'gray',
...
/>
 ...
 <Button
        title="Your Total Number Divided By Four"
