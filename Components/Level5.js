...
const handleCalculateTotal = () => {
  ...
  const handleCalculateDivider = () => {
    ...
    const CalculatedDivider = (number1 + number2 + randomNumber)/6;
    ...
    const calculatedFinalResult = (number1+number2+randomNumber) / 6-sNumber1;
  ...
  const handleCalculateResult = () => {
    ...
    const calculatedResult = randomNumber / 6;
...
const handleNumber1Change = (text) => {
  ...
  return (
    < ScrollView>
      ...
      <Button
         title="Go Back To Level 4"
      onPress={navigateToLevel4}
...
/>
<Text>Automatically Taken Five Times of Your  Number</Text>
      <TextInput
  style={{
    height: 40,
    borderColor: 'gray',
...
/>
 ...
 <Button
        title="Your Total Number Divided By Six"
