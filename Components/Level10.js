...
const Level10 = ({ navigation }) => {
  const navigateToLevel9 = () => {
    navigation.navigate('Level 9');
  };
const navigateToLevel11 = () => {
    navigation.navigate('Math Master Pro');
  };
...
const handleNumber1Change = (text) => {
    ...
    setNumber2(parseInt(text, 10)*10);
};
...
/>
<Text>Automatically Taken Ten Times of Your  Number</Text>
      <TextInput
  style={{
    height: 40,
    borderColor: 'gray',
...
/>
 ...
 <Button
        title="Your Total Number Divided By Ten"
...
/>
    ...
    <Button
         title="Go for Math Master Pro"
      onPress={navigateToLevel11}
