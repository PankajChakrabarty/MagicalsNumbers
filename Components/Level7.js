...
const Level7 = ({ navigation }) => {
  const navigateToLevel6 = () => {
    navigation.navigate('Level 6');
  };
const navigateToLevel8 = () => {
...
const handleCalculateTotal = () => {
  ...
  const handleCalculateDivider = () => {
    ...
    const CalculatedDivider = (number1 + number2 + randomNumber)/8;
    ...
    const calculatedFinalResult = (number1+number2+randomNumber) / 8-sNumber1;
  ...
  const handleCalculateResult = () => {
    ...
    const calculatedResult = randomNumber / 8;
...
const handleNumber1Change = (text) => {
  ...
  return (
    < ScrollView>
      ...
      <Button
         title="Go Back To Level 6"
      onPress={navigateToLevel6}
...
/>
<Text>Automatically Taken Seven Times of Your  Number</Text>
      <TextInput
  style={{
    height: 40,
    borderColor: 'gray',
...
/>
 ...
 <Button
        title="Your Total Number Divided By Eight"
