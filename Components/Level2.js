...
const handleCalculateTotal = () => {
  ...
  const handleCalculateDivider = () => {
    ...
    const CalculatedDivider = (number1 + number2 + randomNumber)/3;
    ...
    const calculatedFinalResult = (number1+number2+randomNumber) / 3-sNumber1;
  ...
  const handleCalculateResult = () => {
    ...
    const calculatedResult = randomNumber / 3;
...
const handleNumber1Change = (text) => {
  ...
  return (
    < ScrollView>
     ...
     <Button
         title="Go Back To Level 1"
      onPress={navigateToLevel1}
...
/>
<Text>Automatically Taken Twice of Your  Number</Text>
      <TextInput
  style={{
    height: 40,
    borderColor: 'gray',
...
/>
 ...
 <Button
        title="Your Total Number Divided By Three"
