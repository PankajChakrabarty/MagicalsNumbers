...
const handleCalculateTotal = () => {
  ...
  const handleCalculateDivider = () => {
    ...
    const CalculatedDivider = (number1 + number2 + randomNumber)/9;
    ...
    const calculatedFinalResult = (number1+number2+randomNumber) / 9-sNumber1;
  ...
  const handleCalculateResult = () => {
    ...
    const calculatedResult = randomNumber / 9;
...
/>
<Text>Automatically Taken Eight Times of Your  Number</Text>
      <TextInput
  style={{
    height: 40,
    borderColor: 'gray',
...
/>
 ...
 <Button
        title="Your Total Number Divided By Nine"
