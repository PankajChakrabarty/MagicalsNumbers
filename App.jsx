...
import { View, ScrollView, TextInput, Button, Text,RefreshControl } from 'react-native';
...
<Text style={{ fontSize: 20, marginTop: 30, paddingLeft:90 }}>Magical Numbers</Text>

     <Button
        title="You Got the Bonus Number"
